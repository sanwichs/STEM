...
from .utils import *
import scipy
from pytorch_adapt.layers import MMDBatchedLoss
...
class SOmodel(BaseModel):
    def __init__(self, opt):
        ...
        self.optimizer = torch.optim.SGD(self.netE.parameters(), lr=opt.lr)
        ...
        self.mmd_fn = MMDBatchedLoss(mmd_type='quadratic')
